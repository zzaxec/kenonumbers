...
public class OpsMethods{
	 ...
	 *
	 * @param txt
	 *          der zu zerlegene String, der die Zahlen enthÃ¤lt, welche
	 ...
	 * berücksichtigt er nur Zahlen, dessen Wahrscheinlichkeit sich um einen
	 * vorher festgelegten Wert von der Durchschnittswahrscheinlichkeit variiert
	 * und die Zahlen der letzten Ziehung vernachlässigt werden. Die Toleranz der
